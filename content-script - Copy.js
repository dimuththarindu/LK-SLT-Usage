...
totalMonthlylimit = circumference('//*[@id="myUsagePanel"]/div/div[1]/div[1]/div[2]/div[1]/div[1]/div/div[2]/div[1]/h5/strong/text()'); // 90.0GB 
totalRemaining = circumference('//*[@id="myUsagePanel"]/div/div[1]/div[1]/div[2]/div[1]/div[1]/div/div[2]/div[2]/h5/strong/text()'); // 73.3GB
totalUsed = circumference('//*[@id="myUsagePanel"]/div/div[1]/div[1]/div[2]/div[1]/div[1]/div/div[2]/div[3]/h5/strong/text()'); // 16.7GB
peakMonthlylimit = circumference('//*[@id="myUsagePanel"]/div/div[1]/div[1]/div[2]/div[1]/div[2]/div/div[2]/div[1]/h5/strong/text()'); // 36.0GB
peakRemaining = circumference('//*[@id="myUsagePanel"]/div/div[1]/div[1]/div[2]/div[1]/div[2]/div/div[2]/div[2]/h5/strong/text()'); // 26.6GB
peakUsed = circumference('//*[@id="myUsagePanel"]/div/div[1]/div[1]/div[2]/div[1]/div[2]/div/div[2]/div[3]/h5/strong/text()'); // 09.4GB

offPeakMonthlylimit = Number((totalMonthlylimit - peakMonthlylimit).toFixed(2)); // 90-36 = 54GB
offPeakUsed = Number((totalUsed - peakUsed).toFixed(2)); // 16.7-09.4 = 07.3GB
offPeakRemaining = Number((offPeakMonthlylimit - offPeakUsed).toFixed(2)); // 54-07.3 = 46.7GB
...
peakDataPerDay = Number((peakMonthlylimit / daysInThisMonth).toFixed(2));
peakDataAvailablePerDay = Number((peakRemaining / (daysInThisMonth - dayOfTheMonth)).toFixed(2));

offPeakDataPerDay = Number((totalMonthlylimit / daysInThisMonth).toFixed(2));
offPeakDataAvailablePerDay = Number((offPeakRemaining / noOfComingDays).toFixed(2));

avgUsage = Number((totalUsed / dayOfTheMonth).toFixed(2));
avgPeakUsage = Number((peakUsed / dayOfTheMonth).toFixed(2));
avgOffPeakUsage = Number((offPeakUsed / dayOfTheMonth).toFixed(2));
...
function circumference(xPathValue) {
    var x = 0;
    try {
